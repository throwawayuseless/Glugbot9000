...
/datum/overmap/ship
	...
	base_token_icon_state = "ship" //PENTEST ADDITION
...
/datum/overmap/ship/proc/update_visuals()
	...
	if(direction & EAST)
		...
		char_rep = "v"
	if(direction)
		token.icon_state = base_token_icon_state +"_moving" //PENTEST ADDITION
		token.dir = direction
	else
		token.icon_state = base_token_icon_state //PENTEST ADDITION
