...
/datum/supply_pack/machinery/rndboards
	name = "RND Starter Kit"
	desc = "Everything needed to get an RND department running or to expand your ship properly! Without the hassle!"
	cost = 10000
	contains = list(/obj/item/storage/box/rndboards/old)
	crate_name = "rnd starter kit crate"
	crate_type = /obj/structure/closet/crate/secure/science
