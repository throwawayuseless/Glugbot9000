...
/obj/item/clothing/head/fedora/terragov
	name = "terran hat"
	icon_state = "hat_solgov"
	item_state = "hat_solgov"
	desc = "A slick blue hat used by both terran civilians and physicists."
...
/obj/item/clothing/head/flatcap/terragov
	name = "terran flat cap"
	desc = "A working terran's hat, commonly used by Logistics Deck Officers."
...
/obj/item/clothing/head/terragov_surgery
	name = "TerraGov surgery cap"
	desc = "It's a surgery cap utilized by Terran doctors."
