/obj/item/clothing/under/terragov
	...
	desc = "Standard combat tunic used by Shock Troopers."
...
/obj/item/clothing/under/terragov/terragov
	name = "\improper TerraGov tunic"
	desc = "Specialized combat tunic utilized by Shock Troopers serving the Terran Regency."
...
/obj/item/clothing/under/plasmaman/terragov
	...
	desc = "The pride of Terran plasmamen everywhere- though this tends to be a somewhat exclusive club, due to Sol's agressive workplace safety regulations."
	icon = 'icons/obj/clothing/under/solgov.dmi' //ogan i am going to kill you i stg
	mob_overlay_icon = 'icons/mob/clothing/under/solgov.dmi'
	icon_state = "plasma_solgov"
	item_state = "plasma_solov"
	can_adjust = FALSE
