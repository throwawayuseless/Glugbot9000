...
/obj/item/clothing/head/helmet/space/terragov
	name = "\improper TerraGov Vacuum Helmet"
...
/obj/item/clothing/suit/space/terragov
	name = "\improper TerraGov Vacuum Suit"
	icon_state = "vacsuit_solgov"
	desc = "Originally designed by independent contractors on Luna for the purposes of survival in hazardous environments, the lightweight Tortoise Microlite Armored Suit now sees widespread use by TerraGov's exploration teams."
