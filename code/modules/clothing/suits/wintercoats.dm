...
/obj/item/clothing/suit/hooded/wintercoat/terragov
	name = "terragov winter coat"
	desc = "An environment-resistant wintercoat in the colors of the Terran Federation."
	icon_state = "coatsolgov"
	item_state = "coatsolgov"
	hoodtype = /obj/item/clothing/head/hooded/winterhood/terragov

/obj/item/clothing/head/hooded/winterhood/terragov
