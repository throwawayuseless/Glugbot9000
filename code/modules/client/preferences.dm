	...
	switch(current_tab)
		...
		if(1) //Character Appearance
			...
			if(HAIR in pref_species.species_traits)
				...
				dat += "<a href='?_src_=prefs;preference=previous_hairstyle;task=input'>&lt;</a> <a href='?_src_=prefs;preference=next_hairstyle;task=input'>&gt;</a>" // PENTEST CHANGE ORDER
				dat += "<a href='?_src_=prefs;preference=hairstyle;task=input'>[hairstyle]</a>" // PENTEST CHANGE ORDER
				...
				dat += "<a href='?_src_=prefs;preference=previous_facehairstyle;task=input'>&lt;</a> <a href='?_src_=prefs;preference=next_facehairstyle;task=input'>&gt;</a>" // PENTEST CHANGE ORDER
