...
/obj/item/gun/ballistic/rifle/terragov
	name = "SSG-669C"
	desc = "A bolt-action sniper rifle used by Terran troops. Beloved for its rotary design and accuracy. Chambered in 8x58mm Caseless."
	mag_type = /obj/item/ammo_box/magazine/internal/boltaction/terragov
	icon_state = "ssg669c"
	item_state = "ssg669c"
