...
/obj/item/gun/ballistic/automatic/pistol/terragov
	...
	desc = "A favorite of the Terran Regency that is despised by the Terran bureaucracy. Shifted out of military service centuries ago, though still popular among civilians. Chambered in 5.56mm caseless."
