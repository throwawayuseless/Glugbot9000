...
/obj/item/gun/ballistic/revolver/russian
	...
	desc = "A Terran revolver for particularly lethal drinking games. It has a mechanism requiring you to spin the chamber before each trigger pull. Uses .357 ammo."
