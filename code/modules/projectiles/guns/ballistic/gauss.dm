...
/obj/item/gun/ballistic/automatic/powered/gauss/modelh
	name = "Model H"
	desc = "A standard-issue pistol exported from the Terran Replublic. It fires slow flesh-rending ferromagnetic slugs at a high energy cost, however they are ineffective on any armor."
...
/obj/item/gun/ballistic/automatic/powered/gauss/modelh/suns
	desc = "A standard-issue pistol exported from the Terran Replublic. It fires slow flesh-rending ferromagnetic slugs at a high energy cost, however they are ineffective on any armor. It is painted in the colors of SUNS."
	mag_type = /obj/item/ammo_box/magazine/modelh
...
/obj/item/gun/ballistic/automatic/powered/gauss/claris
	name = "Claris"
	desc = "An antiquated Terran rifle. Chambered in ferromagnetic pellets, just as the founding Terrans intended."
...
/obj/item/gun/ballistic/automatic/powered/gauss/claris/suns
	desc = "An antiquated Terran rifle. Chambered in ferromagnetic pellets, just as the founding Terrans intended. Evidently, SUNS' founders echo the sentiment, as it appears to be painted in their colors."
	icon_state = "claris_suns"
	item_state = "claris_suns"

/obj/item/gun/ballistic/automatic/powered/gauss/gar
	name = "Solar 'GAR' Carbine"
	desc = "A Terran carbine, unusually modern for its producers. Launches ferromagnetic lances at alarming speeds."
