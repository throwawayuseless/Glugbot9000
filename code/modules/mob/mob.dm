...
/mob/verb/abandon_mob()
	...
	to_chat(usr, "<span class='boldnotice'>You have hit respawn! If you pick the same character, think up lore to explain why there is multiple bodies. Cloned, perhaps?</span>")
