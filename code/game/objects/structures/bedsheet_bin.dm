...
/obj/item/bedsheet/terragov
	name = "\improper TerraGov bedsheet"
	desc = "It has the emblem of the TeraGov emblazoned upon it!"
...
/obj/item/bedsheet/double/terragov
	name = "double TerraGov bedsheet"
	icon_state = "double_sheetsolgov"
	item_state = "double_sheetsolgov"
	dream_messages = list("bureaucracy", "laws", "papers", "writing")
	desc = "It has the emblem of TerraGov emblazoned upon it!"
