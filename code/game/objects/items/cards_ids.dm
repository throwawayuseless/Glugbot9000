...
/obj/item/card/id/terragov
	name = "\improper TerraGov keycard"
	desc = "A TerraGov keycard with no proper access to speak of."
	assignment = "Officer"
	icon_state = "solgov"
	uses_overlays = FALSE

/obj/item/card/id/terragov/commander
	name = "\improper TerraGov commander keycard"
	desc = "A TerraGov keycard with no proper access to speak of. This one indicates a Commander."
