...
/datum/dynamic_ruleset/midround/autotraitor
	...
	protected_roles = list("Prisoner", "Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Prisoner", "Chief Engineer", "Research Director", "Chief Medical Officer", "Head of Personnel", "TerraGov Representative")
...
/datum/dynamic_ruleset/midround/malf
	...
	enemy_roles = list("Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Scientist", "Chemist", "Research Director", "Chief Engineer", "TerraGov Representative")
...
/datum/dynamic_ruleset/midround/from_ghosts/xenomorph/execute()
	...
	for(var/obj/machinery/atmospherics/components/unary/vent_pump/temp_vent in GLOB.machines)
		if(QDELETED(temp_vent))
			continue
		if(istype(get_area(temp_vent), /area/ship) && !temp_vent.welded)
