...
/obj/machinery/suit_storage_unit/terragov
	name = "terragov suit storage unit"
	suit_type = /obj/item/clothing/suit/space/terragov
	helmet_type = /obj/item/clothing/head/helmet/space/terragov
	mask_type = /obj/item/clothing/mask/breath
