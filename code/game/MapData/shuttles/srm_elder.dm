...
/obj/item/book/manual/srmlore
	...
	dat = {"<html>
			...
			expansionist period of space exploration by TerraGov colonists. Formed by large
			group of hunters who banded together to form a sort of citizen's militia.
			When these TerraGov colonists came to Illestren, the brought with them the
